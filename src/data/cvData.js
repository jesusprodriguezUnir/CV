  ...
  experience: [
    {
      ...
      bullets: {
        es: [
          ...
          "Liderazgo técnico en la implementación de soluciones basadas en IA Generativa utilizando Claude y modelos de OpenAI.",
        ...
        en: [
          ...
          "Technical leadership in GenAI solutions implementation using Claude and OpenAI models.",
          ...
          "Workflow automation and system integrations using n8n.",
        ],
      },
      tags: ["n8n", "GenAI", "Claude", "GitHub Copilot", "Tech Leadership", "Open Code", "Angular 18", ".NET 8", "Python", "Docker", "TeamCity", "Azure DevOps", "SonarQube", "DDD", "Mediator Pattern"],
    },
    {
  ...
  skills: [
    {
      ...
      items: ["Claude", "GitHub Copilot (Advanced)", "Open Code", "Prompt Engineering"],
    },
    {
